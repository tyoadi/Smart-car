...
public class Helpx extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.help_x);

        //sound
        final MediaPlayer clickSound = MediaPlayer.create(Helpx.this, R.raw.select);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                clickSound.start();
                Intent intent = new Intent(Helpx.this, MainActivity.class);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                clickSound.start();
                Intent intent = new Intent(Helpx.this, Helpxx.class);
                startActivity(intent);
            }
        });
        ...
        btnPrev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                clickSound.start();
                Intent intent = new Intent(Helpx.this, HelpActivity.class);
                startActivity(intent);
            }
        });
    }
